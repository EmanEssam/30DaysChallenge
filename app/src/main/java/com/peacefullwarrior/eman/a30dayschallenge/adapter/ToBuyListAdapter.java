...
import com.peacefullwarrior.eman.a30dayschallenge.activity.EditToBuyListActivity;
...
public class ToBuyListAdapter extends RecyclerView.Adapter<ToBuyListAdapter.TaskViewHolder> {
    List<Task> taskList = new ArrayList<>();
    Context context;
    List<String> keys = new ArrayList<>();

    public ToBuyListAdapter() {
    }

    public ToBuyListAdapter(List<Task> taskList, List<String> keys, Context context) {
    ...
    @NonNull
    @Override
    public ToBuyListAdapter.TaskViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        Context context = parent.getContext();
        LayoutInflater inflater = LayoutInflater.from(context);
        View view = inflater.inflate(R.layout.task_row, parent, false);
        return new ToBuyListAdapter.TaskViewHolder(view);

    }

    @Override
    public void onBindViewHolder(@NonNull ToBuyListAdapter.TaskViewHolder holder, final int position) {
    ...
    private void openEditActivity(String key) {
        Intent intent = new Intent(context, EditToBuyListActivity.class);
